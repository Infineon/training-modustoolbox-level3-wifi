...
void http_client_task(void *arg){
	...
	// TODO: Populate the members of the variable credentials
	// Hint: Look in http_client.h for the server certificate
	// Hint: The server will not validate the client, so the client cert and key are not required
