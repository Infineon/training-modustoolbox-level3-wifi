...
// TODO: define the SERVERPORT macro - what port is used for https?
#define SERVERPORT							()
...
"-----BEGIN CERTIFICATE-----\n"\
"The client certificate is not required since the server does not validate the client\n"\
"-----END CERTIFICATE-----\n"

/* SSL client private key. */
#define SSL_CLIENTKEY_PEM          \
"-----BEGIN PRIVATE KEY-----\n"\
"The client private key is not required since the server does not validate the client\n"\
"-----END PRIVATE KEY-----\n"
