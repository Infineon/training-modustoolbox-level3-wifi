...
/* Structure for I2C instance used by OLED display and getting temperature from pressure sensor */
cyhal_i2c_t i2c;
...
int main(){
    ...
    /* Initialize i2c used by OLED display and getting temperature from pressure sensor */
    ...
    printf("\x1b[2J\x1b[;H");
    printf("===============================================================\n");
    printf("ModusToolbox-Level3-WiFi - Final Project: IoT Thermostat\n");
    printf("===============================================================\n\n");
