...
void publisher_task(void *pvParameters){
    ...
    /* Variable to receive new device state from capsense thread, temperature thread, or display thread */
    ...
    while(true){
        /* Wait for notification from capsense, temperature, or subscriber tasks. */
